...
This project is an academic and analytical study intended for educational purposes.
...
We apply Dijkstra’s Algorithm to compute the shortest path from a source
node to all other nodes in the graph, focusing on finding the optimal route
